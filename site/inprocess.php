            ...
            <div class="container topnav">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li>
                            <a href="contact.php"><span style="margin-right: 5px"class="glyphicon glyphicon-collapse-down"></span> Контакты</a>
                        </li>
                    </ul>
                </div>
                <!-- /.navbar-collapse -->
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        while ($row = mysqli_fetch_array($data)) {
                            ...
                            $resultending="<div class=container>"."<div class=row>"."<div class = col-md-12>"."<h1 class=text-center style=margin-bottom:20px>".$row['header']."</h1>"."<div class=row>"."<div class = col-md-6>".'<img src="' . GW_UPLOADPATH . $row['image'] . '" alt="Score image" / class="img-rounded">'."</div>"."<div class = col-md-5>".$row['text'].'<a href="page.php?inprocess_show='.$readfurther.'">'."Читать далее".'</a>'."</div>"."</div>"."</div>"."</div>"."</div>"."</div>";
                            if ($x % 2 == 0) {
